...
void RuntimeDecorator::decorateRuntime(jsi::Runtime &rt, std::string label) {
  ...
  rt.global().setProperty(rt, "_LABEL", jsi::String::createFromUtf8(rt, label));
  ...
  jsi::Function __reanimatedWorkletInit = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "__reanimatedWorkletInit"), 1, dummyFunction);
  ...
  jsi::Value log = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_log"), 1, callback);
  ...
  rt.global().setProperty(rt, "_setGlobalConsole", jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_setGlobalConsole"), 1, setGlobalConsole));
}
...
void RuntimeDecorator::decorateUIRuntime(jsi::Runtime &rt,
  ...
  jsi::Value updateProps = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_updateProps"), 2, clb);
  ...
  jsi::Value requestAnimationFrame = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "requestAnimationFrame"), 1, clb2);
  ...
  jsi::Value scrollToFunction = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_scrollTo"), 4, clb3);
  ...
  jsi::Value measureFunction = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_measure"), 1, clb4);
  ...
  jsi::Value timeFun = jsi::Function::createFromHostFunction(rt, jsi::PropNameID::forUtf8(rt, "_getCurrentTime"), 0, clb6);
